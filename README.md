...
For the rendering of the report in pdf format, refer to [release](https://github.com/LuciaMellini/AMD_project/releases/tag/Latest).
...
```
The precomputed output of the script is provided in the [latest release](https://github.com/LuciaMellini/AMD_project/releases/tag/Latest).
